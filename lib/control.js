...
class TorControl extends EventEmitter {
   ...
   * @event module:granax/control~TorControl#error
   * @type {Error}
   */

  /**
   * Fires when the controller is authenticated and ready to send commands
   * @event module:granax/control~TorControl#ready
   * @type {module:granax/control~TorControl}
   */

  /**
   * Fires when the underlying socket closes
   * @event module:granax/control~TorControl#close
   */
